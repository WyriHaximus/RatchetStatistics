...
class RatchetPhuninPubSub extends AbstractRatchetPhuninPlugin implements \WyriHaximus\PhuninNode\PluginInterface {
 ...
 */
	public function getConfiguration(\React\Promise\DeferredResolver $deferredResolver) {
		...
		$this->__configuration->setPair('active_connections.label', 'Active Connections');
 ...
 */
	public function getValues(\React\Promise\DeferredResolver $deferredResolver) {
		$command = new RatchetMessageQueueGetPubSubCommand();
