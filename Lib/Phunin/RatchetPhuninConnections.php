...
class RatchetPhuninConnections extends AbstractRatchetPhuninPlugin implements \WyriHaximus\PhuninNode\PluginInterface {
 ...
 */
	public function getConfiguration(\React\Promise\DeferredResolver $deferredResolver) {
		...
		$this->__configuration->setPair('graph_title', 'Connection Counts');

		$this->__configuration->setPair('users.label', 'Users');
		$this->__configuration->setPair('guests.label', 'Guests');
